...
export const create= async ({model,data=[{}],options={ validateBeforeSrver:true}}={})=>{
    return await model.create(data,options)
}

export const updatePass= async ({model, newPass,id}={})=>{
    return await model.updateOne({_id:id},{ $set: { password: newPass }})
}
